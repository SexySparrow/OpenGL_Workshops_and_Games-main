...
void Laborator2::Init()
{
	...
	// Create a mesh box using custom data
	{
		...
		Mesh *cube = CreateMesh("cube2", vertices, indices);
	}
...

	{
		vector<VertexFormat> vertices_tetra
		{
			...
			VertexFormat(glm::vec3(2, 1, 0), glm::vec3(0, 1, 0)),
		...
		CreateMesh("square", vertices_tetra, indices_tetra);
	}
}
...
void Laborator2::Update(float deltaTimeSeconds)
{
	...
	RenderMesh(meshes["cube1"], shaders["VertexColor"], glm::vec3(0, 0, 0), glm::vec3(1));
	RenderMesh(meshes["cube2"], shaders["VertexColor"], glm::vec3(5, 0, 0), glm::vec3(1));
	RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(2, 0, 0));
	RenderMesh(meshes["tetrahedron"], shaders["VertexColor"], glm::vec3(-2, 0, 0));
