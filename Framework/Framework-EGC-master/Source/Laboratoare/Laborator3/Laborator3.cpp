...
void Laborator3::Init()
{
	...
	Mesh* square1 = Object2D::CreateSquare("square1", corner, squareSide, glm::vec3(0.5, 0, 0), true);
...
void Laborator3::Update(float deltaTimeSeconds)
{
...

	{
		...
		if (moveRight)
		{
			translateX += 0.1 * deltaTimeSeconds * resolution.x;
			modelMatrix *= Transform2D::Translate(translateX, translateY);

			if (translateX > resolution.x * 0.1)
			{
				moveRight = false;
			}
